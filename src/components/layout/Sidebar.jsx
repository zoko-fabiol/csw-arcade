  ...
  const content = (
    <div className="flex flex-col justify-between h-full select-none font-mono">
      ...
      <div>
        ...
        <nav className="px-2 sm:px-3 py-2 space-y-1 overflow-y-auto flex-1 scrollbar-thin scrollbar-thumb-neutral-800">
          <span className="px-3 text-[10px] uppercase tracking-wider text-neutral-500 font-bold">
            Catégories
          </span>
          {genres.map((genre) => {
